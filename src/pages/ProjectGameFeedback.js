            ...
            <Card style={styles.card2}>
                ...
                <CardContent>
                    <div id="listBox2">
                        ...
                        color="info"
                        variant="contained"
                        href="CasinoRoyale/Feedback">BR#000008</Button>
                    </div>
                    <div id="listBox2">
                        <Button 
                        color="info"
                        variant="contained"
                        href="CasinoRoyale/Feedback">BR#000026</Button>
                    </div>
                </CardContent>
            </Card>
            <Card style={styles.card2}>
                ...
                <CardContent>
                    <div id="listBox2">
                        ...
                        color="success"
                        variant="contained"
                        href="CasinoRoyale/Feedback">BR#000022</Button>
                    </div>
                    <div id="listBox2">
                        <Button 
                        color="success"
                        variant="contained"
                        href="CasinoRoyale/Feedback">BR#000025</Button>
                    </div>
                    <div id="listBox2">
                        <Button 
                        color="success"
                        variant="contained"
                        href="CasinoRoyale/Feedback">BR#000021</Button>
                    </div>
                </CardContent>
            </Card>        
        </div>
